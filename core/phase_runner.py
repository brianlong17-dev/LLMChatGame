...
class PhaseRunner:
    ...
    def run_round(self, round, immunity_types):
        ...
        self.game_board.phase_progress_string = self.current_recipe.phase_progress_string(self.game_manager, 
    ...
    def run_phase(self, recipe: 'PhaseRecipe'):
        ...
        self.game_board.new_phase(recipe, self.simulation_engine.game_manager) 
