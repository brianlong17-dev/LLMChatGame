...
from tests.helpers.game_test_helpers import TestGameSink


def test_prisoners_dilemma_split_vs_steal():
    game = GamePrisonersDilemma(GameBoard(NoopGameMaster(), TestGameSink()), SimpleNamespace(agents=[], gameplay_config=GameConfig()))
